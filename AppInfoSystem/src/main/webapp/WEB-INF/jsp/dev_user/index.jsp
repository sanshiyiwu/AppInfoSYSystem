...
<body class="nav-md">
    ...
    <div class="container body">
        ...
        <div class="main_container">
            ...
            <div class="col-md-3 left_col" style="background: #2A3F54;">
    ...
    <!-- moris js -->
    <script src="<%=request.getContextPath() %>/statics/js/moris/raphael-min.js"></script>
    <script src="<%=request.getContextPath() %>/statics/js/moris/morris.js"></script>
    <script src="<%=request.getContextPath() %>/statics/js/moris/example.js"></script>
