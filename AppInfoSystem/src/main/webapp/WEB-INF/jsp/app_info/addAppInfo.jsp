	            ...
	            <div class="x_panel"> 	            
                    <form class="form-horizontal form-label-left" action="javascript:;" method="post" enctype="multipart/form-data" id="addForm">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="categoryLevel2" id="categoryLevel2" onchange="getCategoryLevel2()">
                                    <option>选项</option>   
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input id="status" type="hidden" name="status" value="1" class="form-control col-md-7 col-xs-12" required="required">
                                </c:if>
                                </c:forEach>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3">LOGO图片 <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
